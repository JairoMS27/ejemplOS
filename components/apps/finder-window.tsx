...
export function FinderWindow({
    ...
    const loadSavedImages = () => {
      try {
        ...
        const formattedImages: FileItem[] = images.map((img: any) => ({
          name: img.name,
          type: "image",
          icon: <ImageIcon className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-300" />,
          size: "PNG",
  ...
  const filesData: Record<string, FileItem[]> = {
    Inicio: [
      { name: "Documentos", type: "folder", icon: <Folder className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-400 fill-zinc-400/20" /> },
      { name: "Descargas", type: "folder", icon: <Folder className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-400 fill-zinc-400/20" /> },
      { name: "Imágenes", type: "folder", icon: <Folder className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-400 fill-zinc-400/20" /> },
      { name: "Música", type: "folder", icon: <Folder className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-400 fill-zinc-400/20" /> },
      {
        name: "Juegos",
        type: "app",
        appType: "games",
        icon: <Gamepad2 className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-400 fill-zinc-400/20" />,
        size: "App",
      },
      {
        name: "Aplicaciones",
        type: "folder",
        icon: <LayoutGrid className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-400 fill-zinc-400/20" />,
      },
    ],
    Escritorio: [
      {
        ...
        icon: <DoorOpen className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-300" />,
        size: "Link",
        modified: "Hoy",
      },
      {
        ...
        icon: (
          <svg className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-300" viewBox="0 0 24 24" fill="currentColor">
      ...
      },
      {
        ...
        type: "app",
        appType: "games",
        icon: <Gamepad2 className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-300" />,
        size: "Carpeta",
        modified: "Hoy",
      },
      {
        name: "Mis Proyectos",
        type: "folder",
        icon: <FolderOpen className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-400 fill-zinc-400/20" />,
        size: "Carpeta",
        modified: "Hoy",
      },
      {
        ...
        type: "app",
        appType: "paint",
        icon: <Palette className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-300" />,
        size: "App",
        modified: "Hoy",
      },
      {
        ...
        type: "app",
        appType: "settings",
        icon: <Settings className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-300" />,
        size: "App",
        modified: "Hoy",
      },
      {
        ...
        type: "app",
        appType: "ejpod",
        icon: <Music className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-300" />,
        size: "App",
        modified: "Hoy",
      },
      {
        ...
        type: "app",
        appType: "browser",
        icon: <Globe className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-300" />,
        size: "App",
        modified: "Hoy",
      },
    ],
    ...
    Documentos: [
      {
        name: "Proyecto.txt",
        type: "document",
        icon: <FileText className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-300" />,
        size: "12 KB",
        modified: "Hoy",
      },
      {
      ...
      },
      {
        name: "Manual.pdf",
        type: "file",
        icon: <File className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-300" />,
        size: "2.4 MB",
        modified: "Ayer",
      },
      {
    ...
    Descargas: [
      {
        name: "instalador.dmg",
        type: "file",
        icon: <HardDrive className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-500" />,
        size: "145 MB",
        modified: "Hoy",
      },
      {

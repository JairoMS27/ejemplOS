...
type SettingsTab = "personalization" | "display" | "sound" | "storage" | "about"
...
export function SettingsWindow({ isMaximized }: SettingsWindowProps) {
  ...
  const tabs: { id: SettingsTab; label: string; icon: React.ReactNode }[] = [
    { id: "personalization", label: "Personalizacion", icon: <Paintbrush className="w-4 h-4" /> },
    { id: "display", label: "Pantalla", icon: <Monitor className="w-4 h-4" /> },
    { id: "sound", label: "Sonido", icon: <Volume2 className="w-4 h-4" /> },
    { id: "storage", label: "Almacenamiento", icon: <HardDrive className="w-4 h-4" /> },
  ...
  return (
    <div className="flex flex-col sm:flex-row h-full bg-zinc-950 text-zinc-100">
      ...
      <div className="flex-1 overflow-y-auto p-3 sm:p-6 bg-black/20">
        ...
        {activeTab === "personalization" && (
          <div className="space-y-4 sm:space-y-6 max-w-2xl">
            ...
            <SettingsCard title="Fondo de escritorio" description="Elige el tipo de fondo para tu escritorio">
              <div className="grid grid-cols-3 gap-2 mb-4">
                ...
                >
                  ...
                  <span className="text-xs">Color solido</span>
                </button>
                <button
              ...
              {settings.wallpaper.type === "solid" && (
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 mt-3">
                    <span className="text-xs text-zinc-400">Color personalizado:</span>
                    <input
                      type="color"
                  ...
                  {settings.wallpaper.imageUrl && (
                    <>
                      <div className="relative w-full h-32 rounded-lg overflow-hidden border border-white/10">
                        ...
                        <span className="absolute bottom-2 left-2 text-xs text-white/70">Vista previa</span>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 sm:flex gap-2">
                          {(["cover", "contain", "fill", "none"] as const).map((fit) => (
                            ...
                            >
                              {fit === "cover" ? "Cubrir" : fit === "contain" ? "Contener" : fit === "fill" ? "Estirar" : "Original"}
                            </button>
                          ))}
                        </div>
                      </div>
            ...
            {/* Watermark Settings */}
            <SettingsCard title="Marca de agua" description="Configura las letras 'EJ' del fondo">
              <div className="space-y-4">
                ...
                {settings.desktop.showWatermark && (
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-zinc-400">Opacidad</span>
        ...
        {activeTab === "display" && (
          <div className="space-y-6 max-w-2xl">
            <div>
              <h2 className="text-xl font-semibold text-white mb-1">Pantalla</h2>
              <p className="text-sm text-zinc-500">Opciones de visualizacion del escritorio</p>
            </div>

            <SettingsCard title="Cuadricula de fondo" description="Configura la cuadricula decorativa del escritorio">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                ...
                {settings.desktop.showGrid && (
                  <>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-zinc-400">Tamano de celda</span>
            ...
            <SettingsCard title="Animaciones" description="Activa o desactiva las animaciones del sistema">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-zinc-400" />
                  <span className="text-sm">Animaciones del sistema</span>
                </div>
                <ToggleSwitch
        ...
        {activeTab === "sound" && (
          <div className="space-y-6 max-w-2xl">
            <div>
              <h2 className="text-xl font-semibold text-white mb-1">Sonido</h2>
              <p className="text-sm text-zinc-500">Control de audio del sistema</p>
            </div>

            <SettingsCard title="Volumen del sistema" description="Ajusta el volumen general">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-white/10">
                  <span className="text-sm text-zinc-400">Silenciar audio</span>
            ...
            {audio.currentTrack && (
              <SettingsCard title="Reproduciendo ahora" description="Pista de audio actual">
                <div className="flex items-center gap-3 p-2 bg-white/5 rounded-lg">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-zinc-500">
                      {audio.isPlaying ? "Reproduciendo" : "Pausado"}
                    </p>
                  </div>
                </div>
              </SettingsCard>
        ...
        {activeTab === "storage" && (
          <div className="space-y-6 max-w-2xl">
            <div>
              <h2 className="text-xl font-semibold text-white mb-1">Almacenamiento</h2>
              <p className="text-sm text-zinc-500">Informacion sobre los datos guardados</p>
            </div>

            <SettingsCard title="Uso del almacenamiento local" description="Datos guardados en este navegador">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                  <div>
                    <p className="text-sm text-white">Espacio utilizado</p>
                    <p className="text-xs text-zinc-500">{storageInfo.items} elementos guardados</p>
                  </div>
            ...
            <SettingsCard title="Datos guardados" description="Tipos de datos almacenados">
              <div className="space-y-2">
                <div className="flex items-center justify-between p-2 bg-white/5 rounded-lg">
                  <div className="flex items-center gap-2">
                    <Paintbrush className="w-4 h-4 text-zinc-400" />
                    <span className="text-sm">Imagenes de Paint</span>
                  </div>
                  <span className="text-xs text-zinc-500">
                    {localStorage.getItem("paint_images") ?
                      JSON.parse(localStorage.getItem("paint_images") || "[]").length + " imagenes"
                      : "Sin datos"}
                  </span>
                </div>
                <div className="flex items-center justify-between p-2 bg-white/5 rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">Configuracion del sistema</span>
                  </div>
            ...
            <SettingsCard title="Limpiar datos" description="Elimina los datos guardados">
              <button
        ...
        {activeTab === "about" && (
          <div className="space-y-6 max-w-2xl">
            <div>
              <h2 className="text-xl font-semibold text-white mb-1">Acerca de</h2>
              <p className="text-sm text-zinc-500">Informacion del sistema operativo</p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">Version 1.1.0 Beta</p>
                  </div>
                </div>
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Sistema operativo web simulado construido con React, Next.js y Tailwind CSS.
                  Disenado para demostrar interfaces de usuario modernas y funcionales.
                </p>
              </div>
            </SettingsCard>

            <SettingsCard title="Especificaciones tecnicas" description="">
              <div className="space-y-2">
                {[
                  ...
                  { label: "Navegador", value: typeof navigator !== "undefined" ? navigator.userAgent.split(" ").slice(-2).join(" ") : "Desconocido" },
                ].map((item) => (
            ...
            <SettingsCard title="Caracteristicas" description="">
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  "Juegos (Buscaminas, Tetris, Snake, 2048)",
                  "Ventanas redimensionables",
                  "Personalizacion de escritorio",
            ...
            <div className="text-center text-xs text-zinc-600 py-4">
              <p>© 2025 EjemplOS. Todos los derechos reservados.</p>
            </div>
          </div>
        )}
      </div>
      ...
      {showResetConfirm && (
        <div className="absolute inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-zinc-900 border border-white/10 rounded-xl p-6 max-w-sm mx-4 shadow-2xl">
            <h3 className="text-lg font-semibold text-white mb-2">Restablecer ajustes</h3>
            <p className="text-sm text-zinc-400 mb-4">
              Esto restablecera todos los ajustes a sus valores predeterminados. Esta accion no se puede deshacer.
            </p>
      ...
      {showClearConfirm && (
        <div className="absolute inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-zinc-900 border border-white/10 rounded-xl p-6 max-w-sm mx-4 shadow-2xl">
            <h3 className="text-lg font-semibold text-white mb-2">Limpiar almacenamiento</h3>
            <p className="text-sm text-zinc-400 mb-4">
              Esto eliminara todos los datos guardados excepto la configuracion del sistema. Las imagenes de Paint seran eliminadas.
            </p>
            <div className="flex justify-end gap-2">
              <button
